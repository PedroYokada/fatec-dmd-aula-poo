# ☕ Programação Orientada a Objetos — ILP002
...
O objetivo é desenvolver conhecimentos necessários para construção e organização de aplicações utilizando o paradigma de **Programação Orientada a Objetos**.

Durante as atividades são praticados conceitos como:
...
## 📘 Lista 1 — Fundamentos e estruturas de repetição
...
## 📗 Lista 2 — Estruturas condicionais e decisões
...
Implementação de um **Jogo da Velha para dois jogadores** utilizando Java.

O projeto trabalha diversos conceitos estudados durante as aulas, como:
...
Este repositório funciona como um registro das atividades realizadas durante a disciplina de **Programação Orientada a Objetos**, acompanhando a evolução desde os fundamentos da linguagem Java até o desenvolvimento de aplicações orientadas a objetos mais completas.
